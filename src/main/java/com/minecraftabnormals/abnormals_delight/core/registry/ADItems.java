...
public class ADItems {
	...
	public static final RegistryObject<Item> CHERRY_COOKIE = HELPER.createCompatFastItem("cherry_cookie", new Item.Properties().food(Foods.COOKIES), ItemGroup.TAB_FOOD, ADConstants.ENVIRONMENTAL);
	...
	public static final RegistryObject<Item> ESCARGOT = HELPER.createCompatContainerConsumableItem("escargot", new ResourceLocation(ADConstants.AUTUMNITY, "snail_shell_piece"), new Item.Properties().food(Foods.ESCARGOT).stacksTo(16), ItemGroup.TAB_FOOD, ADConstants.AUTUMNITY);
