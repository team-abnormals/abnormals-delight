...
public class ADConstants {
	...
	// Items & Blocks
	public static final ResourceLocation CRUSTOSE = ResourceLocation.fromNamespaceAndPath(ATMOSPHERIC, "crustose");
	public static final ResourceLocation CRUSTOSE_LOG = ResourceLocation.fromNamespaceAndPath(ATMOSPHERIC, "crustose_log");
