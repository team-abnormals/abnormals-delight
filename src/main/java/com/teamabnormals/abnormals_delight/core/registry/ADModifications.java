...
import com.teamabnormals.abnormals_delight.core.registry.ADItems.ADFoods;
		...
		if (ADConfig.COMMON.replaceFDItemGroup.get()) {
			...
			for (Item item : ForgeRegistries.ITEMS.getValues()) {
				if (item.getRegistryName().getNamespace().equals(FarmersDelight.MODID)) {
					...
					else if (DECORATIONS.contains(item) || item instanceof SignItem) setItemGroup(item, CreativeModeTab.TAB_DECORATIONS);
