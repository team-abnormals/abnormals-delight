...
public class ADBlocks {
	...
	public static final RegistryObject<Block> LAUREL_CABINET = HELPER.createCompatFuelBlock(ADConstants.ATMOSPHERIC, "laurel_cabinet", () -> new AbnormalsCabinetBlock(Block.Properties.copy(Blocks.BARREL)), 300, CreativeModeTab.TAB_DECORATIONS);
